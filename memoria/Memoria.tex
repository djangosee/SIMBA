...
Un cop realitzat l'anàlisi de la variancia i si aquest confirma l'existencia de diferencies significatives entre els grups o tractaments, es convenient investigar quines mitjanes son diferents. El conjunt de tècniques que tracten aquest problema es denominen \textit{contrastos per comparacions múltiples}.
\\
