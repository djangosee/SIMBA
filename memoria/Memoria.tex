...
\caption{Dels gens significatius per al teixit \textbf{Ilenum}, s'apliquen comparacions 2 a 2 Gene-Tractament. A la taula només es mostren aquells pvalors quasi significatius o significatius.}
\end{table}
...
\caption{Dels gens significatius per al teixit \textbf{Jejunum}, s'apliquen comparacions 2 a 2 Gene-Tractament. A la taula només es mostren aquells pvalors quasi significatius o significatius.}
\end{table}

\begin{center}
\includegraphics[scale=0.9]{TukeyJeju.png}
...
\captionof{figure}{Biplot de les mitjanes per cada gene-tractament del teixit \textbf{Ilenum}.}
\end{center}
...
\captionof{figure}{Biplot de les mitjanes per cada gene-tractament del teixit \textbf{Jejunum}.}
\end{center}
...
\begin{center}
\includegraphics[scale=0.9]{lineploti.png}
...
\end{center}
\begin{center}
\includegraphics[scale=0.9]{lineplotj.png}
