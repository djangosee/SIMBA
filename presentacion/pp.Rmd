...
2. ![SGB](genom.jpg){width=50px}: Especialistas en genómica obtienen la matriz de expressión genética.
...
- La posibilidad de añadir mejoras y en la aplicación. (Futuras versiones)
- Carácter multidisciplinar del trabajo: estadística, biomedicina y bioinformática.
